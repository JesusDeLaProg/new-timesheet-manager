...
export type PhoneNumberValid = PhoneNumber;

/**
 * Describes the message google.type.PhoneNumber.
 * Use `create(PhoneNumberSchema)` to create a new message.
 */
export const PhoneNumberSchema: GenMessage<PhoneNumber, {validType: PhoneNumberValid}> = /*@__PURE__*/
...
export type PhoneNumber_ShortCodeValid = PhoneNumber_ShortCode;

/**
 * Describes the message google.type.PhoneNumber.ShortCode.
 * Use `create(PhoneNumber_ShortCodeSchema)` to create a new message.
 */
export const PhoneNumber_ShortCodeSchema: GenMessage<PhoneNumber_ShortCode, {validType: PhoneNumber_ShortCodeValid}> = /*@__PURE__*/
